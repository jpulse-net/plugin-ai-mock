# jPulse Docs / Installed Plugins / AI Mock Provider Plugin v1.0.15
...
3. On **Site Configuration → AI Agent**, leave the default provider empty (the first registered provider is used) or set it to `ai-mock` / `mock-echo`.
